...
<a class="navbar-brand h1 mb-0" href="investview.php"><h5><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> INVESTMENT TABLE</h5></a>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link btn btn-success btn-sm" href="investview.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> ADD NEW <i class="fa fa-home" aria-hidden="true"></i></a>
            </li>
...
<div class="container-fluid justify-content-center table-responsive">
        <table id="myTable" class="table table-striped" cellspacing="2">
            <thead class="thead-dark">
                <tr class="rowspan=2">
                    ...
                    <th>INVESTMENT AMOUNT(CEDIS)</th>
                    <th>INVESTMENT AMOUNT(DOLLARS)</th>
   ...
   ?>
        <tr> 
                ...
                <td>
                    <a href="investview.php?edit=<?php echo $row['id'];?>" class="btn btn-info">EDIT</a>
                    <a href="investTable.php?delete=<?php echo $row['id'];?>" class="btn btn-danger">DELETE</a>
                </td>
        </tr>
   <?php endwhile;?>
 </table>
