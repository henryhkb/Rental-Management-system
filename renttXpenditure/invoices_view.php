    ...
    <section class="row justify-content-center container">  
        <!--Creating a form for the house view-->   
            ...
            <input type="hidden" name="id" value="<?php echo $id;?>">
                ...
                <div class="form-group">
                    <label for="housenumber">phonenumber</label>
                    <input type="text" class="form-control" name="phonenumber" id="housenumber" value="<?php echo $housenumber;?>" required='required'>
                </div>
                ...
                <div class="form-group">
                    <label for="Paid Amount">Comments</label>
                    <input type="text" class="form-control" name="comments" value="<?php echo $comments;?>">
                 </div>

                <div class="form-group">
                    <label for="Balance">Particulars</label>
                    <input type="text" class="form-control" name="particulars" value="<?php echo $particulars;?>">
                 </div>
