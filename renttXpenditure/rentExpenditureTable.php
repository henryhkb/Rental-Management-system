...
<a class="navbar-brand h1 mb-0" href="houses_view.php"><h5><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> RENT EXPENSE TABLE</h5></a>
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link btn btn-success btn-sm" href="rentExpenditure_view.php"><i class="fa fa-plus-circle" aria-hidden="true"></i> ADD NEW <i class="fa fa-home" aria-hidden="true"></i></a>
            </li>
