...
<head>
    ...
    <title>RENT EXPENDITURE VIEW</title>
   <style>
.form-container{
    top: 2vh;
...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
 ...
 GO TO DASHBOARD</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <?php require_once 'rentExpendituredml.php';?>
    <div class="container">
    <section class="row justify-content-center container">
        <!--Creating a form for the house view-->    
            ...
            <input type="hidden" name='id' value='<?php echo $id;?>'>
                <header><h4> <i class="fa fa-building-o" aria-hidden="true"></i>  YOUR RENT EXPENDITURE</header></header>
                <br>
                ...
                <div class="form-group">
                    ...
                    <textarea cols="5" rows="5" class="form-control" name="expenseAmount" placeholder="Enter expense Amount" value="<?php echo $expenseAmount;?>" required="required"><?php echo $expenseAmount;?></textarea>
                </div>
                
                <div class="form-group">
                    <label for="ExpenseDate">Date of Expense</label> 
                    <input type="date" class="form-control input-group date"  name="date" placeholder="EnterDate" value="<?php echo $date;?>" required="required">
                </div>
